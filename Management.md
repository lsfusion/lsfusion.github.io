...
### [System parameters](/System_parameters/.md)[​](#system-parameters "Direct link to system-parameters")

Contains a description of system parameters that affect its launch and shutdown in one way or another.

### [User interface](/User_interface/.md)[​](#user-interface "Direct link to user-interface")

Explains how to configure the graphical user interface.

### [Interpreter](/Interpreter/.md)[​](#interpreter "Direct link to interpreter")
...
### [Security policy](/Security_policy/.md)[​](#security-policy "Direct link to security-policy")

Contains a description of the settings for accessing system elements depending on the user working in the system.

### [Scheduler](/Scheduler/.md)[​](#scheduler "Direct link to scheduler")
...
### [Process monitor](/Process_monitor/.md)[​](#process-monitor "Direct link to process-monitor")
