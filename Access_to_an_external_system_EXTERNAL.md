...
### HTTP - web server HTTP request[​](#http "Direct link to HTTP - web server HTTP request")
...
#### Parameters[​](#table "Direct link to Parameters")
...
### LSF - calling an action of another lsFusion server[​](#lsf---calling-an-action-of-another-lsfusion-server "Direct link to LSF - calling an action of another lsFusion server")
...
### DBF - writing rows to a `.dbf` file[​](#dbf "Direct link to dbf")
