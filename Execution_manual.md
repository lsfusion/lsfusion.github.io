...
### Installing the application server as a service[​](#installing-the-application-server-as-a-service "Direct link to Installing the application server as a service")
...
### Installing the web server (web and desktop client) as a service[​](#appservice "Direct link to Installing the web server (web and desktop client) as a service")
...
### Installing only the desktop client (on the client's computer)[​](#installing-only-the-desktop-client-on-the-clients-computer "Direct link to Installing only the desktop client (on the client's computer)")
