...
Similar to [**Example 2**](#example-2), except that the hierarchy is attached by the [`Hierarchy`](/Utils_Hierarchy.md) system module instead of declaring `parent[Category]` by hand.
