...
Recommendations for storing data in the database — [tables](/Tables/.md), [materializations](/Materializations/.md) and [indexes](/Indexes/.md). The common mandatory rules are in [Rules](/Rules/.md); this article is not part of the set always passed to the assistant and is requested when needed.
