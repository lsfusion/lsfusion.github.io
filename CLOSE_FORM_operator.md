...
The `CLOSE FORM` operator creates an [action](/Actions.md) that closes the open forms a given address names in the [interactive view](/In_an_interactive_view_SHOW_DIALOG.md).
