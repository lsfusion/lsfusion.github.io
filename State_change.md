...
### Asynchronous update[​](#asyncupdate "Direct link to Asynchronous update")
...
To declare an asynchronous-update action, use the [`ASYNCUPDATE` operator](/ASYNCUPDATE_operator/.md).
