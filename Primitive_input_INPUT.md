...
### Requested value[​](#value "Direct link to Requested value")
...
### Offered values[​](#list "Direct link to Offered values")
...
### Common input capabilities[​](#common-input-capabilities "Direct link to Common input capabilities")
...
The syntax of the value input operator is described by the [`INPUT` operator](/INPUT_operator/.md).
