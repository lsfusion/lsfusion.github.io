...
To access design components, you can use their names or address property components on the form (`PROPERTY`), the parent component (`PARENT`), property group components (`GROUP`), and other base components/default design components. A property component created by a predefined [object operator](/Interactive_view/.md#objectoperators) is addressed by the operator name with its object mapping, for example `PROPERTY(NEW(o))`, `PROPERTY(NEW[Order](o))`, `PROPERTY(EDIT(o))`, or `PROPERTY(DELETE(o))`, unless the property was given an explicit name on the form.
...
### Container properties[​](#container-properties "Direct link to Container properties")
...
### Properties of actions and properties on the form[​](#properties-of-actions-and-properties-on-the-form "Direct link to Properties of actions and properties on the form")
...
### `selector` parameters[​](#selector-parameters "Direct link to selector-parameters")
...
![](/assets/images/DESIGN_instruction-7364b4b4c703078e55a694077d5ce2f7.png)
