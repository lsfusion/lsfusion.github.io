...
The [Score table](/Score_table/.md) example describes how to create a simple application that calculates the score table of a hockey tournament. It contains exactly one form, in which the user can enter game scores, based on which the score table is automatically built.
...
### Materials management[​](#materials-management "Direct link to Materials management")
...
### UEFA country coefficient calculation[​](#uefa-country-coefficient-calculation "Direct link to UEFA country coefficient calculation")

[This example](https://habr.com/ru/company/lsfusion/blog/467279/) describes an application that calculates the UEFA country coefficient based on the information about the played matches.
