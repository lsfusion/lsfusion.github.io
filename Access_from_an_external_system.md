...
##### Parameters[​](#url "Direct link to Parameters")
...
##### Request properties[​](#request "Direct link to Request properties")
...
##### Result computed for a created object[​](#result-computed-for-a-created-object "Direct link to Result computed for a created object")
...
##### Several results / parameters in BODY[​](#several-results--parameters-in-body "Direct link to Several results / parameters in BODY")
...
### Listing files[​](#listing-files "Direct link to Listing files")
...
### Reading a file[​](#reading-a-file "Direct link to Reading a file")
...
### Searching file contents[​](#searching-file-contents "Direct link to Searching file contents")
...
### Action API (Python)[​](#action-api-python "Direct link to Action API (Python)")
