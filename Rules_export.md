...
Recommendations for exporting data with the [`EXPORT` operator](/EXPORT_operator/.md). The common mandatory rules are in [Rules](/Rules/.md); this article is not part of the set always passed to the assistant and is requested when needed.
