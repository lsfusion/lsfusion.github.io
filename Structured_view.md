...
* '
  ...
  ' This postfix disables the [embedding of JSON values](#innerjson): the property value is exported as a string even if it is itself JSON. Example:
...
### Flat view[​](#flat "Direct link to Flat view")
