...
* '
  ...
  ' This postfix means that if the value contains JSON or something resembling JSON (starts and ends with square or curly brackets), we will treat it as a string instead of as JSON. Example:
...
### Hierarchical view[​](#hierarchy "Direct link to Hierarchical view")
...
### Predefined value[​](#value "Direct link to Predefined value")
