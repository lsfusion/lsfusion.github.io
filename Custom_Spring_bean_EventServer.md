# Custom Spring bean (EventServer)
...
### Threads and stack[​](#threads-and-stack "Direct link to Threads and stack")
...
### Wiring up in Spring[​](#wiring-up-in-spring "Direct link to Wiring up in Spring")
