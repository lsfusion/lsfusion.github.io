...
## Доменная логика — базовые элементы (от простых к сложным)[​](#доменная-логика--базовые-элементы-от-простых-к-сложным "Прямая ссылка на этот заголовок")
...
## Физическая модель — из чего собран проект и как он исполняется[​](#физическая-модель--из-чего-собран-проект-и-как-он-исполняется "Прямая ссылка на этот заголовок")
...
### Исполнение — как подсказать платформе, где хранить и как обрабатывать[​](#исполнение--как-подсказать-платформе-где-хранить-и-как-обрабатывать "Прямая ссылка на этот заголовок")
