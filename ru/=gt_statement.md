...
но при этом позволяет автоматически разрешать ситуации нарушения этого ограничения. Так тип разрешения `RESOLVE LEFT` будет эквивалентен созданию [простого события](/ru/Simple_event/.md):
...
* `resolveType`
  ...
  Тип [автоматического разрешения](/ru/Simple_event/.md) при нарушении следствия. Задается одним из следующих вариантов:
...
* `eventClause`
  ...
  [Блок описания события](/ru/Event_description_block/.md). Описывает [событие](/ru/Events/.md), при наступлении которого будет проверяться создаваемое следствие и выполняться операции автоматического разрешения.
