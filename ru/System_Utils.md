...
### Содержимое файлов и кодировки[​](#содержимое-файлов-и-кодировки "Прямая ссылка на этот заголовок")
...
### Архивы[​](#архивы "Прямая ссылка на этот заголовок")
...
### Консоль и сеть[​](#консоль-и-сеть "Прямая ссылка на этот заголовок")
...
### Excel[​](#excel "Прямая ссылка на этот заголовок")
...
### PDF и Word[​](#pdf-и-word "Прямая ссылка на этот заголовок")
...
### Итерация[​](#итерация "Прямая ссылка на этот заголовок")

`iterate[INTEGER, INTEGER, INTEGER]` — рекурсивная развёртка диапазона целых от `from` до `to`. `count[INTEGER, INTEGER]` — частный случай: `iterate(i, 1, count)`. См. аналогичный `iterate` для дат в [`Time`](/ru/System_Time/.md).

### Цвет[​](#цвет "Прямая ссылка на этот заголовок")

`colorToHexString[COLOR]` — представление цвета в виде `'#RRGGBB'`.

### Полнотекстовый поиск[​](#полнотекстовый-поиск "Прямая ссылка на этот заголовок")
...
### Свойства доступа к JSON[​](#json-access "Прямая ссылка на этот заголовок")
...
### Локальные файловые свойства[​](#локальные-файловые-свойства "Прямая ссылка на этот заголовок")
...
### Журналирование[​](#журналирование "Прямая ссылка на этот заголовок")
...
### Диалоговые формы[​](#диалоговые-формы "Прямая ссылка на этот заголовок")
...
### Среда выполнения[​](#среда-выполнения "Прямая ссылка на этот заголовок")
...
* [Оператор `JSON`](/ru/JSON_operator/.md) — построение JSON-значения из свойств или формы.
* [Оператор `FORMULA`](/ru/FORMULA_operator/.md) — синтаксис, через который объявлены большинство свойств модуля.
* [Оператор `IMPORT`](/ru/IMPORT_operator/.md) — чтение JSON-файла в форму или через `FIELDS … DO`.

### Связано[​](#связано "Прямая ссылка на этот заголовок")

* [`System modules`](/ru/System_modules/.md) — общий список модулей платформы.
* [`Custom formula (FORMULA)`](/ru/Custom_formula_FORMULA/.md) — механизм, через который объявлены большинство свойств модуля.
* [`Time`](/ru/System_Time/.md) — отдельный модуль работы со временем.
