...
Оператор *композиции* создаёт [свойство](/ru/Properties/.md), значением которого является другое свойство — *главное* — применённое к значениям, возвращаемым другими свойствами, переданными как его *аргументы*.
