...
### Компьютеры[​](#компьютеры "Прямая ссылка на этот заголовок")
...
### Контакты[​](#контакты "Прямая ссылка на этот заголовок")
...
### Пользователи[​](#пользователи "Прямая ссылка на этот заголовок")
...
### Пароли и токены[​](#пароли-и-токены "Прямая ссылка на этот заголовок")
...
### Текущий пользователь[​](#текущий-пользователь "Прямая ссылка на этот заголовок")
...
### Провайдеры и настройки аутентификации[​](#провайдеры-и-настройки-аутентификации "Прямая ссылка на этот заголовок")
...
### Настройки двухфакторной аутентификации[​](#настройки-двухфакторной-аутентификации "Прямая ссылка на этот заголовок")
...
### API-действия[​](#api-действия "Прямая ссылка на этот заголовок")
...
### Политика и надёжность пароля[​](#политика-и-надёжность-пароля "Прямая ссылка на этот заголовок")
...
### Настройки локали[​](#настройки-локали "Прямая ссылка на этот заголовок")
...
### Управление сессией и пользователем[​](#управление-сессией-и-пользователем "Прямая ссылка на этот заголовок")
...
### Блокировки объектов[​](#блокировки-объектов "Прямая ссылка на этот заголовок")
...
* [Заголовок модуля](/ru/Module_header/.md) — синтаксис `MODULE` / `REQUIRE`; модуль `Authentication` подключается через `REQUIRE Authentication`.
* [Оператор `DATA`](/ru/DATA_operator/.md) — объявляет хранимые свойства пользователей, контактов и настроек.
...
* [`SystemEvents`](/ru/System_SystemEvents/.md) — события входа и подключения.
* [`Time`](/ru/System_Time/.md) — классы диапазонов пикеров и помощники по дате/времени.
