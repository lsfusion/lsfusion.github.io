...
![](/ru/assets/images/Backup_restore_backups-2ec9f62a91a16e9c47bbb10dab0be31a.png)
...
![](/ru/assets/images/Backup_restore_settings-0ef0edf17c8a2b764df0eff5a4b681dd.png)
...
### Создание резервной копии[​](#создание-резервной-копии "Прямая ссылка на этот заголовок")
...
* `Проредить` – немедленно применяет правила хранения (см. [Хранение](#%D1%85%D1%80%D0%B0%D0%BD%D0%B5%D0%BD%D0%B8%D0%B5)).

После установки платформа создаёт задание планировщика `Резервное копирование`, которое запускается ежедневно в 01:00 и выполняет `Backup.makeBackup[]`, а затем `Backup.decimateBackups[]`. Расписание и список действий можно редактировать так же, как у любого другого задания – см. [Планировщик](/ru/Scheduler/.md).
...
#### Оперативные копии[​](#оперативные-копии "Прямая ссылка на этот заголовок")
...
![](/ru/assets/images/Backup_restore_exclude-2ec9f62a91a16e9c47bbb10dab0be31a.png)
...
### Хранение[​](#хранение "Прямая ссылка на этот заголовок")
...
### Восстановление данных[​](#восстановление-данных "Прямая ссылка на этот заголовок")
...
#### Полное восстановление[​](#полное-восстановление "Прямая ссылка на этот заголовок")
...
4. Выполните `pg_restore --dbname=<dbname> <backup_file>` для пустой базы данных. Утилиты `pg_restore`, `dropdb` и `createdb` берутся из `Путь к каталогу bin PostgreSQL` (см. [Настройки](#%D0%BD%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B8)) или из системного `PATH`.
...
![](/ru/assets/images/Backup_restore_full_restore-5bdfb86478725c347d7356b7da1b4404.png)
...
#### Выборочное восстановление[​](#выборочное-восстановление "Прямая ссылка на этот заголовок")

Форма выборочного восстановления открывается из `Администрирование > Система > Планировщик > Восстановление данных` (рис. 4.).

![](/ru/assets/images/Backup_restore_custom_restore-15336516b5682df5184a6fedf8fd5fb8.png)
