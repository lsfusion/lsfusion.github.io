...
### Установка фильтра[​](#установка-фильтра "Прямая ссылка на этот заголовок")
...
### Чтение фильтра[​](#чтение-фильтра "Прямая ссылка на этот заголовок")
...
* [`Выполнение программного кода (EVAL)`](/ru/Eval_EVAL/.md) — выполнение сгенерированного кода lsFusion, используемое здесь для чтения и повторного применения фильтров формы.
* [`Формы`](/ru/Forms/.md) — что такое форма, её группы объектов, фильтры и порядки.
* [`Reflection`](/ru/System_Reflection/.md) — метаданные о формах, группах объектов и свойствах, к которым здесь обращаются по имени.
