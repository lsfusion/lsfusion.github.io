...
*Лексема* в языке программирования - это минимальная значимая последовательность символов. В языке **lsFusion** лексемами являются ключевые слова, [простые идентификаторы](/ru/IDs/.md), [литералы](/ru/Literals/.md) и специальные последовательности символов.
