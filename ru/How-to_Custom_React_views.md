...
Компонент React может рисовать и окно, в котором открываются формы, вместо стандартных вкладок. Окну [`WINDOW`](/ru/WINDOW_statement.md) `System.forms` задаётся имя компонента, а его данными становятся открытые формы:
