...
### Локаль[​](#locale "Прямая ссылка на этот заголовок")
...
### Форматы задания параметров локали[​](#форматы-задания-параметров-локали "Прямая ссылка на этот заголовок")
...
### Локализация строковых данных[​](#локализация-строковых-данных "Прямая ссылка на этот заголовок")
