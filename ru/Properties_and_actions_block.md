...
* `viewType`
  ...
  Указание [типа представления](/ru/Interactive_view/.md#property) добавляемого свойства или действия:
...
* `PIVOT calcType`
  ...
  Указание агрегирующей функции, которая будет использоваться для значений добавляемого свойства при группировке строк (в том числе в [виде представления *сводная таблица*](/ru/Pivot_block/.md)). `calcType` задается одним из ключевых слов `SUM`, `MAX`, `MIN`.
