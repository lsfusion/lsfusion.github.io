...
* `cparam1, ..., cparamN`
  ...
  Список общих параметров блока. Каждый параметр задается именем объекта формы. Если этот список задан, то при добавлении свойства (действия) нужно указывать только его идентификатор без параметров. Имя объекта задается [простым идентификатором](/ru/IDs.md#id).
...
#### Опции свойства или действия[​](#опции-свойства-или-действия "Прямая ссылка на этот заголовок")
