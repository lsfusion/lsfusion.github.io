...
* `CLASS propertyExpression`
  ...
  Указание свойства, значение которого определяет CSS-классы (через пробел) элемента значения добавляемого свойства. Аналогично свойству `valueClass` в [инструкции `DESIGN`](/ru/DESIGN_statement/.md).
