...
#### Отправка[​](#отправка "Прямая ссылка на этот заголовок")
...
#### Приём[​](#приём "Прямая ссылка на этот заголовок")
...
### Письмо[​](#письмо "Прямая ссылка на этот заголовок")
...
### Приём почты[​](#приём-почты "Прямая ссылка на этот заголовок")
