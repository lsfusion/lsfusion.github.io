...
`Редактирование объекта` - может ли пользователь вызвать [событие редактирования объекта](/ru/Form_events.md#property) этого свойства; при запрете пункт `Перейти по ссылке` скрыт из контекстного меню свойства, и событие вызвать нельзя.
