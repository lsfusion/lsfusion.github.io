...
Встроенный класс записывается в коде как [идентификатор класса](/ru/IDs.md#classid) - ключевое слово, обозначающее этот класс. Значения встроенных классов записываются в виде [литералов](/ru/Literals.md), каждый из которых имеет свою форму и ограничения.
