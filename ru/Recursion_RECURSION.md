...
Оператор *рекурсии* создает [свойство](/ru/Properties.md), которое последовательно выполняет две операции:
...
Для иерархии, заданной свойством `parent[class]`, типовые рекурсивные свойства — предок, уровень, число потомков, полное имя от корня — даёт готовый системный модуль [`Hierarchy`](/ru/Utils_Hierarchy.md).
