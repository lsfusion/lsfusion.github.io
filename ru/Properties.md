...
Тип и особенности вычисления каждого свойства определяются [оператором](/ru/Property_operators_paradigm/.md), создающим это свойство.

### Ограничение типов[​](#type "Прямая ссылка на этот заголовок")
...
Для создания свойств используется [инструкция `=`](/ru/=_statement/.md).
