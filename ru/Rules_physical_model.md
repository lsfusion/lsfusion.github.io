...
Рекомендации по хранению данных в базе — [таблицам](/ru/Tables/.md), [материализациям](/ru/Materializations/.md) и [индексам](/ru/Indexes/.md). Общие обязательные правила находятся в [Rules](/ru/Rules/.md); эта статья не входит в набор, который всегда передается ассистенту, и запрашивается по мере необходимости.
