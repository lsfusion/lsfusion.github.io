...
Оператор `NEWCONNECTION` - создание [действия](/ru/Actions/.md), которое выполняет другое действие с сохранением [внешних подключений](/ru/New_connection_NEWCONNECTION/.md) (`SQL`, `TCP`, `DBF`) между вызовами [`EXTERNAL`](/ru/EXTERNAL_operator/.md).
