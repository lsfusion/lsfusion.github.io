...
*Логические операторы* создают [свойства](/ru/Properties/.md), которые рассматривают свои операнды как логические значения [класса `BOOLEAN`](/ru/Built-in_classes/.md), и возвращаемым значением которых также является значение класса `BOOLEAN`. Если значение операнда логического оператора не равно `NULL`, то операнд рассматривается как значение `TRUE` класса `BOOLEAN`, иначе `NULL`. Результат всегда равен либо `TRUE`, либо `NULL`, но никогда не `FALSE`.
...
Описание [синтаксиса логических операторов](/ru/AND_OR_NOT_XOR_operators/.md).
