...
Оператор `OVERRIDE` - создание [свойства](/ru/Properties/.md), реализующего [выбор](/ru/Selection_CASE_IF_MULTI_OVERRIDE_EXCLUSIVE/.md#exclusive) одного из значений (полиморфная форма).
