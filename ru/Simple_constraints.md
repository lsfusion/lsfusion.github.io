...
Ограничение-следствие создаётся с помощью [инструкции `=>`](/ru/=gt_statement/.md). Ограничение определённости задаётся [опцией `NONULL`](/ru/Property_options/.md), указываемой при объявлении свойства.
