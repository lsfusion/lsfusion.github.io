...
## Описание задачи "Управление материальными потоками"[​](#описание-задачи-управление-материальными-потоками "Прямая ссылка на этот заголовок")
...
Информационная система будет состоять из подмножества [модулей](/ru/Modules/.md), в каждом из которых реализуется некоторая логически обособленная функциональность. В каждом из модулей может использоваться функциональность других модулей, для чего используются специальные конструкции задания зависимости модулей.
...
### Определение склада[​](#определение-склада "Прямая ссылка на этот заголовок")
...
### Определение товара[​](#определение-товара "Прямая ссылка на этот заголовок")
...
### Определение организации[​](#определение-организации "Прямая ссылка на этот заголовок")
...
### Определение приходной накладной[​](#определение-приходной-накладной "Прямая ссылка на этот заголовок")
...
### Определение расходной накладной[​](#определение-расходной-накладной "Прямая ссылка на этот заголовок")
...
### Определение текущего остатка товара на складе[​](#определение-текущего-остатка-товара-на-складе "Прямая ссылка на этот заголовок")
...
## Исходный код целиком (на [Github](https://github.com/lsfusion/samples/tree/master/mm))[​](#исходный-код-целиком-на-github "Прямая ссылка на этот заголовок")
