...
* `orderExpr1, ..., orderExprL`
  ...
  Список [выражений](/ru/Expression/.md), по которым производится сортировка формируемых данных. Выражения произвольны: они не обязаны входить в список `propertyExpr1, ..., propertyExprN`. Выражение сортировки добавляется во внутренний запрос скрытой колонкой и в результирующий JSON не попадает.
