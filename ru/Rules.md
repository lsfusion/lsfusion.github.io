...
5. Написанный прямо в теле действия или события `PREV(<выражение>)` переносит в состояние начала сессии ВСЁ обёрнутое выражение, включая подвыражения-аргументы: аргумент, вычисленный в текущей сессии (`LOCAL`, свойство объекта, созданного в сессии), внутри `PREV` читается как `NULL`, молча обнуляя результат.
