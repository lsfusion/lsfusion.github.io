...
9. После `APPLY`, если последующая логика зависит от того, удалось ли сохранение, ассистент ОБЯЗАН проверить `canceled()`. Если неудачу нужно донести до пользователя или интеграции, ассистенту СЛЕДУЕТ использовать `applyMessage()`.
