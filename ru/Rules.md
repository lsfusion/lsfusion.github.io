...
5. Ассистент НЕ ДОЛЖЕН сообщать о пробеле в документации той статьи, которую он не читал.

6. Если обязательную статью правил прочитать не удалось, ассистент ОБЯЗАН сказать пользователю, какая область осталась непрочитанной, и НЕ ДОЛЖЕН выдавать результат за проверенный на соответствие правилам.
