...
Определим логику категорий и [первичное свойство](/ru/Data_properties_DATA.md) надбавки для категории.
...
Используя [оператор `RECURSION`](/ru/RECURSION_operator.md) для любых двух категорий посчитаем свойство `'Уровень'`, которое будет равно двойке возведенной в степень расстояния между ними.
