...
* В последовательной форме все реализации выполняются в порядке этого списка внутри одного вызова абстрактного действия: [выход](/ru/Exit_RETURN.md) из реализации завершает этот вызов, и оставшиеся реализации пропускаются.
