...
Так же как и для [оператора ветвления](/ru/Branching_CASE_IF_MULTI/.md#poly), для абстрактного действия существует *полиморфная форма*, когда можно не задавать условие явно, а использовать в качестве условия [принадлежность сигнатуре](/ru/Property_signature_ISCLASS/.md) соответствующего этому условию действия.
