...
Оператор `NESTEDSESSION` - создание [действия](/ru/Actions/.md), которое выполняет другое действие во [вложенной сессии](/ru/New_session_NEWSESSION_NESTEDSESSION/.md#nested).
