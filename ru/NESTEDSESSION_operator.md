...
Оператор `NESTEDSESSION` создаёт [действие](/ru/Actions/.md), которое выполняет другое действие во [вложенной сессии](/ru/New_session_NEWSESSION_NESTEDSESSION/.md#nested).
