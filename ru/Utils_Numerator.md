...
### Нумератор[​](#нумератор "Прямая ссылка на этот заголовок")
...
### Выдача очередного значения[​](#выдача-очередного-значения "Прямая ссылка на этот заголовок")
...
### Нумерация класса[​](#нумерация-класса "Прямая ссылка на этот заголовок")
...
### Нумераторы по умолчанию[​](#нумераторы-по-умолчанию "Прямая ссылка на этот заголовок")
