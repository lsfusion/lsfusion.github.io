...
Оператор *константа* позволяет создавать свойства без параметров, которые всегда возвращают одно и то же значение. Этим значением могут быть [статические объекты](/ru/Static_objects/.md) [пользовательских](/ru/User_classes/.md) и [встроенных](/ru/Built-in_classes/.md) классов, а также специальное значение `NULL`. Класс значения определяется самим значением:
...
Константы записываются как ссылки на [статические объекты](/ru/Static_objects/.md) для значений пользовательских классов и как [литералы](/ru/Literals/.md) для значений встроенных классов и `NULL`.
