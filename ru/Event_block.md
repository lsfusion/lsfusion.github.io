...
Блоки событий [инструкции `FORM`](/ru/FORM_statement/.md) - набор конструкций, управляющих [событиями](/ru/Form_events/.md) в интерактивном представлении формы.
...
* `objName`
  ...
  Имя объекта на форме. [Простой идентификатор](/ru/IDs/.md#id).
...
* `componentSelector`
  ...
  [Селектор](/ru/DESIGN_statement/.md#selector) компонента дизайна.
...
* `eventActionId`
  ...
  [Идентификатор действия](/ru/IDs/.md#propertyid), которое будет являться обработчиком события.
...
* `eventActionOperator`
  ...
  [Контекстно-зависимый оператор-действие](/ru/Action_operators/.md#contextdependent). В качестве параметров этого оператора можно использовать имена уже объявленных объектов на форме.
