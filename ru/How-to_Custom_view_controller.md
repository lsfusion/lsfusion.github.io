...
### Контроллер с высоты птичьего полёта[​](#контроллер-с-высоты-птичьего-полёта "Прямая ссылка на этот заголовок")
