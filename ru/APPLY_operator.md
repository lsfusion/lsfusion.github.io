...
Оператор `APPLY` - создание [действия](/ru/Actions/.md), [применяющего изменения](/ru/Apply_changes_APPLY/.md) в базу данных.
