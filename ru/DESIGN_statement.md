...
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------- | --------------------------------------------- |
| `span`                   | todo                                                                                                                                                                                                                        | [Целочисленный литерал](/ru/Literals/.md#intliteral)                         | `1`                   | `2`                                           |
...
| `activated`              | todo                                                                                                                                                                                                                        | [Логический литерал](/ru/Literals/.md#booleanliteral)                        | `FALSE`               | `TRUE`<br />`FALSE`                           |
...
| `background`             | Цвет, который будет использоваться для отображения фона компонента                                                                                                                                                          | Выражение (значение класса [COLOR](/ru/Literals/.md#colorliteral))           | `#FFFFFF`             | `#FFFFCC`<br />`RGB(255, 0, 0)`               |
