...
Операторы *показа сообщения* создают [действия](/ru/Actions/.md), которые показывают пользователю текстовое сообщение. Сообщение задается как некоторое [свойство](/ru/Properties/.md), значение которого и будет использовано в качестве сообщения. Отображение этого сообщения может происходить либо с помощью диалогового окна, либо в системном окне `System.log`.
