...
Оператор `IF ... THEN` - создание [свойства](/ru/Properties/.md), реализующего [выбор](/ru/Selection_CASE_IF_MULTI_OVERRIDE_EXCLUSIVE/.md) с одним условием (одиночная форма).
