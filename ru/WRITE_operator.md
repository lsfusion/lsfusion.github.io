...
Оператор `WRITE` - создание [действия](/ru/Actions/.md), [записывающего файл](/ru/Write_file_WRITE/.md) из свойства во внешний ресурс.
...
* `urlExpr`
  ...
  [Выражение](/ru/Expression/.md), значением которого является URL.

* `fileExpr`

  [Выражение](/ru/Expression/.md), значением которого является файл, который будет записан во внешний ресурс. Также допускаются значения JSON-типа: в этом случае значение сериализуется в файл с расширением `.json`.
