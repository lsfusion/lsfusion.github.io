...
## Скачать[​](#скачать "Прямая ссылка на этот заголовок")

### Windows[​](#windows "Прямая ссылка на этот заголовок")
...
### Запуск IDE[​](#запуск-ide "Прямая ссылка на этот заголовок")

При использовании автоматической установки, создается ярлык, запускающий IDEA.

![](/ru/assets/images/Development_auto_IDEA-28efba7b9c61ffdb89df81ee93f6a7fc.png)

Описание работы с IDE после ее запуска находится [здесь](/ru/IDE.md).

### Запуск клиента[​](#запуск-клиента "Прямая ссылка на этот заголовок")
...
![](/ru/assets/images/Development_auto_lsFusion-ee6fe270212dd9adce154a948bc911c2.png)
