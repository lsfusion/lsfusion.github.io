...
В *статичном* представлении все данные формы читаются на момент ее [открытия](/ru/Open_form/.md), после чего полученные данные преобразуются:

* либо в [печатное](/ru/Print_view/.md) представление - один из печатных форматов (например **PDF**, **Excel**). Печатное представление также часто принято называть *отчетом*
* либо в [структурированное](/ru/Structured_view/.md) представление - один из соответствующих форматов данных (например **XML**, **JSON**, **CSV**, **DBF**)
...
### Пример построения иерархии групп объектов[​](#hierarchysample "Прямая ссылка на этот заголовок")
