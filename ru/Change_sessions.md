...
Для сессии поддерживаются две основные операции — [применение](/ru/Apply_changes_APPLY/.md) и [отмена](/ru/Cancel_changes_CANCEL/.md), а также набор операторов для [работы с изменениями](/ru/Change_operators_SET_CHANGED_etc/.md) (в том числе получение [предыдущего значения](/ru/Previous_value_PREV/.md) в сессии).
