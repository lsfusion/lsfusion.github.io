# Rules: экспорт данных

## Область действия[​](#область-действия "Прямая ссылка на этот заголовок")

Рекомендации по экспорту данных [оператором `EXPORT`](/ru/EXPORT_operator/.md). Общие обязательные правила находятся в [Rules](/ru/Rules/.md); эта статья не входит в набор, который всегда передается ассистенту, и запрашивается по мере необходимости.
