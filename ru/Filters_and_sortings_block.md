...
* `USER | FIXED`
  ...
  Ключевые слова, определяющие тип фильтра: `FIXED` - фиксированный фильтр (по умолчанию); `USER` - [пользовательский фильтр](/ru/Interactive_view.md#userfilters): строка условия свойства показывается сразу при открытии формы. Выражением должно быть [имя свойства на форме](/ru/Properties_and_actions_block.md#name), то есть свойство должно быть предварительно добавлено на форму.
