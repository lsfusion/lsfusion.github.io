...
* [Группировка (`GROUP`)](/ru/Grouping_GROUP/.md)
* [Разбиение / Упорядочивание (`PARTITION ... ORDER`)](/ru/Partitioning_sorting_PARTITION_..._ORDER/.md)
* [Рекурсия (`RECURSION`)](/ru/Recursion_RECURSION/.md)
* [Распределение (`UNGROUP`)](/ru/Distribution_UNGROUP/.md)
