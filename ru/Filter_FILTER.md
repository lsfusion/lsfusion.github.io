...
Оператор *фильтра* создает [свойство](/ru/Properties/.md), которое возвращает `TRUE`, если набор объектов входит в установленный в заданной группе объектов [фильтр](/ru/Form_structure/.md#filters), и `NULL` в обратном случае.
