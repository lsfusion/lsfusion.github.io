...
### Event types[​](#type "Direct link to Event types")
...
### Executing local events[​](#local "Direct link to Executing local events")
...
### Change operators' event mode[​](#change "Direct link to Change operators' event mode")
