...
## Description of the "Materials management" task[​](#description-of-the-materials-management-task "Direct link to Description of the \"Materials management\" task")
...
## Defining domain logic[​](#defining-domain-logic "Direct link to Defining domain logic")
...
### Defining a stock[​](#defining-a-stock "Direct link to Defining a stock")
...
### Defining an item[​](#defining-an-item "Direct link to Defining an item")
...
### Defining a legal entity[​](#defining-a-legal-entity "Direct link to Defining a legal entity")
...
### Defining a receipt[​](#defining-a-receipt "Direct link to Defining a receipt")
...
### Defining a shipment[​](#defining-a-shipment "Direct link to Defining a shipment")
...
### Defining current item balance[​](#defining-current-item-balance "Direct link to Defining current item balance")
...
## The complete source code (on [Github](https://github.com/lsfusion/samples/tree/master/mm))[​](#the-complete-source-code-on-github "Direct link to the-complete-source-code-on-github")
