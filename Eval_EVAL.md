...
### Execution scope[​](#execution-scope "Direct link to Execution scope")
...
### Restrictions on the executable code[​](#restrictions-on-the-executable-code "Direct link to Restrictions on the executable code")
...
To create the eval action, use the [`EVAL` operator](/EVAL_operator/.md).
