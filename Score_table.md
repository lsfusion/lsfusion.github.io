...
## "Score table" task description[​](#score-table-task-description "Direct link to \"Score table\" task description")
...
## Defining the domain logic[​](#defining-the-domain-logic "Direct link to Defining the domain logic")
...
### Team definition[​](#team-definition "Direct link to Team definition")
...
### Game definition[​](#game-definition "Direct link to Game definition")
...
### Determining the winner of the game[​](#determining-the-winner-of-the-game "Direct link to Determining the winner of the game")
...
### Determining game result[​](#determining-game-result "Direct link to Determining game result")
...
For this purpose we create a `GameResult` class and add three [static objects](/Static_objects/.md) to it that are specified using expressions specified in braces `{ }`. In this case, the values `win`, `winOT`, `winSO` and `W`, `OW`, `SW` will be available through the system properties `name` and `caption`, respectively.
...
### Creating a score table[​](#creating-a-score-table "Direct link to Creating a score table")
...
## Defining view logic[​](#defining-view-logic "Direct link to Defining view logic")
...
## The complete source code[​](#the-complete-source-code "Direct link to The complete source code")
