...
* `name`
  ...
  Object name. Simple ID. Must be specified if the object class is a [built-in class](/Built-in_classes.md). If the object class is a [custom class](/User_classes.md), the name can be omitted, but an object declared without a name cannot be referenced by name anywhere on the form (for example, in `PROPERTIES`, `FILTERS`, or the `PARENT` expression).
...
### Object group options[​](#object-group-options "Direct link to Object group options")
...
## Object extension block[​](#extendobjects "Direct link to Object extension block")
...
## Object tree block[​](#tree "Direct link to Object tree block")
...
## Object tree extension block[​](#extendtree "Direct link to Object tree extension block")
