...
### Installing the IDE Plugin[​](#installing-the-ide-plugin "Direct link to Installing the IDE Plugin")

info

To install the plug-in, IntelliJ IDEA version 2025.2 or higher must be installed on the computer.

### Installing an application server via IDE[​](#installing-an-application-server-via-ide "Direct link to Installing an application server via IDE")
...
### Install desktop client[​](#install-desktop-client "Direct link to Install desktop client")
...
### Install Web Client[​](#install-web-client "Direct link to Install Web Client")
...
## Installation in existing Java projects[​](#installation-in-existing-java-projects "Direct link to Installation in existing Java projects")

### Installing an application server via IDE[​](#existingide "Direct link to Installing an application server via IDE")
...
### Installing the application server via Maven (only for Maven projects)[​](#maven "Direct link to Installing the application server via Maven (only for Maven projects)")
