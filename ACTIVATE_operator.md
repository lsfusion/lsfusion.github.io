...
#### Activating a form, tab, or property[​](#activating-a-form-tab-or-property "Direct link to Activating a form, tab, or property")
...
#### Activating objects in a group[​](#activating-objects-in-a-group "Direct link to Activating objects in a group")
...
* `seekDirection`
  ...
  Option. It specifies the [seek direction](/Activation_ACTIVATE/.md#direction). Possible values:
