...
### Files of a specific type[​](#files-of-a-specific-type "Direct link to Files of a specific type")
...
### Links to files of a specific type[​](#links-to-files-of-a-specific-type "Direct link to Links to files of a specific type")
...
## Default value[​](#defaultvalue "Direct link to Default value")
...
## Extensions of specific type files[​](#extension "Direct link to Extensions of specific type files")
...
## The order of determining the result property when [accessing from an external system](/Access_from_an_external_system/.md#httpresult)[​](#export "Direct link to export")
