...
### Templates[​](#template "Direct link to Templates")
...
### Automatic design[​](#auto "Direct link to Automatic design")
...
### Template format[​](#format "Direct link to Template format")
...
Which template (report file) is used for the form and for its individual reports can be specified explicitly through the [`FORM` statement](/FORM_statement/.md).
