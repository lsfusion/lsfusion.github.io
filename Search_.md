...
## Search steps[​](#search-steps "Direct link to Search steps")
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Modules](/Modules/.md)                                                                                                                                                                                                         |               |                                                                                                                | - Name equals[...](#name)                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                                                    |
| [Forms](/Forms/.md), [Classes](/User_classes/.md), [Navigator Elements](/Navigator/.md), [Property and action groups](/Groups_of_properties_and_actions/.md) , [Tables](/Tables/.md), [Navigator Design](/Navigator_design/.md) |               |                                                                                                                | - Name matches[...](#name)<br />- Located in dependent module[...](#module)<br />- Located in specified namespace (if explicitly specified)[...](#namespace)                                                                                                                                        | - Selection of a priority namespace (if the namespace is not explicitly specified)[...](#priority)                                                                                                                                                                                                 |
| [Metacodes](/Metaprogramming/.md)                                                                                                                                                                                               |               |                                                                                                                | - Name matches[...](#name)<br />- Located in dependent module[...](#module)<br />- Located in specified namespace (if explicitly specified)[...](#namespace)<br />- Number of parameters matches[...](#metacode)                                                                                    | - Selection of a priority namespace (if the namespace is not explicitly specified)[...](#priority)                                                                                                                                                                                                 |
| [Properties](/Properties/.md), [Actions](/Actions/.md)                                                                                                                                                                          | Local         | - Search for property inside action[...](#locals)<br />- Namespace not specified explicitly[...](#nonamespace) | - Name matches[...](#name)<br />- Located upper in the stack[...](#stack)<br />- Parameters classes match[...](#direct)                                                                                                                                                                             | - Selection of more specific classes of parameters[...](#concrete)                                                                                                                                                                                                                                 |
|                                                                                                                                                                                                                                 | Local common  | - Search for property inside action[...](#locals)<br />- Namespace not specified explicitly[...](#nonamespace) | - Name matches[...](#name)<br />- Located upper in the stack[...](#stack)<br />- Parameters classes intersect[...](#indirect)                                                                                                                                                                       |                                                                                                                                                                                                                                                                                                    |
|                                                                                                                                                                                                                                 | Global        |                                                                                                                | - Name matches[...](#name)<br />- Located in dependent module[...](#module)<br />- Located in specified namespace (if explicitly specified)[...](#namespace)<br />- Parameters classes match[...](#direct)<br />- Abstract property (if an abstract property is being searched for)[...](#abstract) | - Selection of a priority namespace (if the namespace is not explicitly specified)[...](#priority)<br />- Selection of non-matching classes of parameters (if an abstract property is being searched for)[...](#notequals)<br />- Selection of more specific classes of parameters[...](#concrete) |
|                                                                                                                                                                                                                                 | Global common | - Not searching for an abstract property[...](#notabstract)                                                    | - Name matches[...](#name)<br />- Located in dependent module[...](#module)<br />- Located in specified namespace (if explicitly specified)[...](#namespace)<br />- Parameters classes intersect[...](#indirect)                                                                                    | - Selection of a priority namespace (if the namespace is not explicitly specified)[...](#priority)                                                                                                                                                                                                 |

Description of steps, conditions and operations of the search algorithm:

### Name matches[​](#name "Direct link to Name matches")
...
### Located in dependent module[​](#module "Direct link to Located in dependent module")

Candidate module [depends on](/Modules/.md#depends) the module in which the search is performed.

### Located in specified namespace (if explicitly specified)[​](#namespace "Direct link to Located in specified namespace (if explicitly specified)")
...
### Selection of a priority namespace (if the namespace is not explicitly specified)[​](#priority "Direct link to Selection of a priority namespace (if the namespace is not explicitly specified)")
...
### Number of parameters matches[​](#metacode "Direct link to Number of parameters matches")

The number of parameters of the candidate is equal to the number of parameters of the call.

### Search for property inside action[​](#locals "Direct link to Search for property inside action")
...
### Namespace not specified explicitly[​](#nonamespace "Direct link to Namespace not specified explicitly")

This step is only executed if no search namespace is specified.

### Located upper in the stack[​](#stack "Direct link to Located upper in the stack")
...
### Suitable classes of parameters[​](#direct "Direct link to Suitable classes of parameters")
...
### Classes of parameters intersect[​](#indirect "Direct link to Classes of parameters intersect")

[Classes of the referring parameters](#call) [intersect](#indirectclasses) with [classes of the candidate's parameters](#decl).

### Selection of more specific classes of parameters[​](#concrete "Direct link to Selection of more specific classes of parameters")
...
### Not searching for an abstract property[​](#notabstract "Direct link to Not searching for an abstract property")
...
### Abstract property (if an abstract property is being searched for)[​](#abstract "Direct link to Abstract property (if an abstract property is being searched for)")

The candidate is an [abstract](/Property_extension/.md) property (action).

### Selection of non-matching classes of parameters (if an abstract property is being searched for)[​](#notequals "Direct link to Selection of non-matching classes of parameters (if an abstract property is being searched for)")
...
### Additional operations to search for properties / actions[​](#additional-operations-to-search-for-properties--actions "Direct link to Additional operations to search for properties / actions")

#### Matching parameter classes[​](#directclasses "Direct link to Matching parameter classes")
...
#### Intersection of parameter classes[​](#indirectclasses "Direct link to Intersection of parameter classes")
...
#### Defining the classes of the referring parameters[​](#call "Direct link to Defining the classes of the referring parameters")
...
#### Determining parameter classes of a property (action)[​](#decl "Direct link to Determining parameter classes of a property (action)")
