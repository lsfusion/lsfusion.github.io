...
## Change session rules (`NEWSESSION`, `NESTEDSESSION`, `APPLY`)[​](#change-session-rules-newsession-nestedsession-apply "Direct link to change-session-rules-newsession-nestedsession-apply")
