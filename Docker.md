...
### Launching the lsFusion platform using Docker Compose[​](#docker-platform "Direct link to Launching the lsFusion platform using Docker Compose")
...
### Creating and running a Docker image of your project[​](#creating-and-running-a-docker-image-of-your-project "Direct link to Creating and running a Docker image of your project")
...
#### Creating a Docker image[​](#creating-a-docker-image "Direct link to Creating a Docker image")
...
#### Generating and using `compose.yaml`[​](#generating-and-using-composeyaml "Direct link to generating-and-using-composeyaml")
...
### Upgrading PostgreSQL[​](#postgres-upgrade "Direct link to Upgrading PostgreSQL")
...
* Dump and restore — the recommended method for most installations: the new cluster is initialized by the image in the normal way, and the data is loaded into it with the standard [pg\_dumpall](https://www.postgresql.org/docs/current/app-pg-dumpall.html):
