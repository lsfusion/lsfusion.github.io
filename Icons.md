...
## Manual assignment[​](#manual "Direct link to Manual assignment")
...
## Automatic assignment[​](#auto "Direct link to Automatic assignment")

info

Automatic icon assignment works only if the `Icon.lsf` module is added to the project.

### General logic[​](#general-logic "Direct link to General logic")
...
### Determining search keywords[​](#determining-search-keywords "Direct link to Determining search keywords")
