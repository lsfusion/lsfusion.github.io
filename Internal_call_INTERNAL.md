...
## Types of internal calls[​](#types-of-internal-calls "Direct link to Types of internal calls")

The platform currently supports the following types of internal calls:

### Java - executing Java code in the application-server JVM[​](#java "Direct link to Java - executing Java code in the application-server JVM")
...
### CLIENT - invoking code or a file in the user's web client[​](#client "Direct link to CLIENT - invoking code or a file in the user's web client")
...
### DB - SQL against the platform's own database[​](#db "Direct link to DB - SQL against the platform's own database")
