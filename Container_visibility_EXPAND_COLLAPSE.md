# Container visibility (EXPAND, COLLAPSE)
...
To declare actions that expand or collapse a container, use the [`EXPAND`](/EXPAND_operator/.md) and [`COLLAPSE`](/COLLAPSE_operator/.md) operators.
