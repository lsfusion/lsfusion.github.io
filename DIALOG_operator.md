...
and the *class-form* opens the [list or edit form](/Interactive_view/.md#edtClass) of a class (specify exactly one of `LIST` or `EDIT`), with one implicit object whose `objSpec` is attached directly:
