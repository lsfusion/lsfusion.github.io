...
### Monitor contents[​](#monitor-contents "Direct link to Monitor contents")
...
#### Process identification[​](#process-identification "Direct link to Process identification")
...
#### Java thread[​](#java-thread "Direct link to Java thread")
...
### Locks[​](#locks "Direct link to Locks")
...
### Interruption and forced termination[​](#interruption-and-forced-termination "Direct link to Interruption and forced termination")
...
### Filter by process type[​](#filter-by-process-type "Direct link to Filter by process type")
