...
### 1. The `enableAPI` parameter[​](#enableapi "Direct link to enableapi")
...
#### Recommended approach: enable per role[​](#recommended-approach-enable-per-role "Direct link to Recommended approach: enable per role")
...
#### Alternative ways to set the value[​](#alternative-ways-to-set-the-value "Direct link to Alternative ways to set the value")
...
### 2. HTTPS is mandatory[​](#https "Direct link to 2. HTTPS is mandatory")
...
### URL example[​](#example-url "Direct link to URL example")
...
### Authorization discovery on a non-root deployment[​](#well-known "Direct link to Authorization discovery on a non-root deployment")
