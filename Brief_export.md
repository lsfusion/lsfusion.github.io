...
* When a form is exported to a flat format, the destination is set per object group: `TO (groupId1 = propertyId1, ...)`; the [empty object group](/Static_view/.md#empty) is named `root`.
