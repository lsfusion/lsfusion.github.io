...
### Formats for specifying locale parameters[​](#formats-for-specifying-locale-parameters "Direct link to Formats for specifying locale parameters")
...
### Determining the current locale[​](#current "Direct link to Determining the current locale")
...
### String data localization[​](#string-data-localization "Direct link to String data localization")
