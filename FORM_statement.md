...
* `USERFILTERS ...`
  ...
  **deprecated since version 7**, use `FILTERS` with `USER` option. Adds [user-defined filters](/Interactive_view/.md#userfilters) to a form. [Syntax of the user filters block](/Filters_and_sortings_block/.md#userfilters).
