...
### Attaching to a class[​](#attaching-to-a-class "Direct link to Attaching to a class")
...
### Hierarchy properties[​](#hierarchy-properties "Direct link to Hierarchy properties")
...
### Additional metacodes[​](#additional-metacodes "Direct link to Additional metacodes")
...
* [`META` statement](/META_statement.md) — declaring a metacode and applying it with the `@` statement, by which the hierarchy is attached to a class.
* [Module header](/Module_header.md) — `REQUIRE Hierarchy`, which pulls the module in.
