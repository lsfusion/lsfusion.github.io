...
### Capture target[​](#target "Direct link to Capture target")
...
### Capture format[​](#format "Direct link to Capture format")
...
### Capture destination[​](#destination "Direct link to Capture destination")
...
### Client support[​](#client "Direct link to Client support")
