...
### Standard groups[​](#standard-groups "Direct link to Standard groups")
...
### Change-session control[​](#change-session-control "Direct link to Change-session control")
...
### HTTP request context[​](#http-request-context "Direct link to HTTP request context")
...
### Caught-exception state[​](#caught-exception-state "Direct link to Caught-exception state")
...
### Opening files and links[​](#opening-files-and-links "Direct link to Opening files and links")
...
### Form lifecycle[​](#form-lifecycle "Direct link to Form lifecycle")
...
### Form context flags[​](#form-context-flags "Direct link to Form context flags")
...
### Polymorphic edit and delete[​](#polymorphic-edit-and-delete "Direct link to Polymorphic edit and delete")
...
### Local buffers[​](#local-buffers "Direct link to Local buffers")
...
### UI defaults[​](#ui-defaults "Direct link to UI defaults")
...
### Runtime and checks[​](#runtime-and-checks "Direct link to Runtime and checks")
...
### File helpers[​](#file-helpers "Direct link to File helpers")
...
### Client-side loading[​](#client-side-loading "Direct link to Client-side loading")
...
* [`+=` statement](/plus_equals_statement.md) — adds a project's implementation of a window-class property.
* [`WINDOW` statement](/WINDOW_statement.md) — declares a window of the project's own, with its CSS class.
