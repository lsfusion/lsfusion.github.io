...
* `CUSTOM 'itemBoard'` — the object group is drawn by the JS function *itemBoard* instead of a table; `PAGESIZE 0` makes the component receive all objects rather than the first page.
...
### The gate[​](#the-gate "Direct link to The gate")
