...
## Core elements (from simpler to more complex)[​](#core-elements-from-simpler-to-more-complex "Direct link to Core elements (from simpler to more complex)")
...
### Additional elements[​](#additional-elements "Direct link to Additional elements")
...
## Property operators[​](#property-operators "Direct link to Property operators")

### Basic expressions[​](#basic-expressions "Direct link to Basic expressions")
...
### Partition / window (`PARTITION`)[​](#partition--window-partition "Direct link to partition--window-partition")
...
### Aggregating objects (`GROUP AGGR`)[​](#aggregating-objects-group-aggr "Direct link to aggregating-objects-group-aggr")

* **Description**: maintains aggregate objects via `BY`.
* **Syntax (search)**: `GROUP AGGR Class x WHERE BaseCondition BY groupExprs...;`

### Operator `AGGR`[​](#operator-aggr "Direct link to operator-aggr")
...
## Action operators[​](#action-operators "Direct link to Action operators")

### Basic operators[​](#basic-operators "Direct link to Basic operators")
...
### FOR loop[​](#for-loop "Direct link to FOR loop")
...
## Form representations[​](#form-representations "Direct link to Form representations")
...
### From current system to external (imperative, actions)[​](#from-current-system-to-external-imperative-actions "Direct link to From current system to external (imperative, actions)")

* **Description**: `EXTERNAL` — HTTP/external code/SQL as actions.
* **Syntax (search)**: `EXTERNAL Name 'id' [OPTIONS] (Params...);`

### From current system to external (declarative, properties)[​](#from-current-system-to-external-declarative-properties "Direct link to From current system to external (declarative, properties)")
...
### From current system to internal (declarative)[​](#from-current-system-to-internal-declarative "Direct link to From current system to internal (declarative)")
...
## Physical model (DB structure)[​](#physical-model-db-structure "Direct link to Physical model (DB structure)")
