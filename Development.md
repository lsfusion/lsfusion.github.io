...
### [Element identification](/Element_identification.md)[​](#element-identification "Direct link to element-identification")

Describes the mechanisms by which system elements in the platform can access each other.

### [Modularity](/Modularity.md)[​](#modularity "Direct link to modularity")

Allows you to simplify the task of designing IS and distributing the IS development process among development teams.

### [Metaprogramming](/Metaprogramming.md)[​](#metaprogramming "Direct link to metaprogramming")

Provides maximum flexibility in code reuse issues.

### [Migration](/Migration.md)[​](#migration "Direct link to migration")

Allows you to control data migration when changing the application logic.

### [Internationalization](/Internationalization.md)[​](#internationalization "Direct link to internationalization")

Allows you to adapt to the linguistic and cultural particularities of various countries and regions.

### [Integration](/Integration.md)[​](#integration "Direct link to integration")
